...
/**
 * Created by GJ on 2016/9/6.
 * titles标题
 * courseId父课程ID
 * type 类型
 */
public class PullZikechengActivity extends BaseActivity {
    ...
    protected void setDataBinding(ViewDataBinding dataBinding) {
        ...
        adapter_kc.setOnItemClickListener(new IcssRecyclerAdapter.OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                //转到我的课程详情
                Intent intent = new Intent(PullZikechengActivity.this, list_kc.get(position).istwo_course_B() ? PullZikechengActivity.class : CourseActivity.class);
    ...
    private void http(boolean isRefresh, boolean showProgress) {
        ...
        icssOkhttp.HttppostString(User.url + "/index.php?mod=site&name=api&do=course&op=childCourseList", new TextLinstener(this) {
            @Override
