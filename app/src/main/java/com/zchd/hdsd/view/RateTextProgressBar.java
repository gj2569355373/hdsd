 ...
 */
public class RateTextProgressBar extends FrameLayout implements CircularProgressBar.OnProgressChangeListener {

    private CircularProgressBar mCircularProgressBar;
    private TextView mRateText;

    public RateTextProgressBar(Context context) {
        super(context);
        init();
    }

    public RateTextProgressBar(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
