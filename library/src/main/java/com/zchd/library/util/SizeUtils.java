...
public class SizeUtils {
    ...
    public static String getdoble00(double i){
        DecimalFormat df = new DecimalFormat("#.00");
        return df.format(i);
    }
    public static String getString00(double i){
        String dw="";
        if (i>1073741824)//GB
        {
            dw="GB";
            dw=getdoble00(i/1024/1024/1024)+dw;
        }
        else if (i>1048576)//MB
        {
            dw="MB";
            dw=getdoble00(i/1024/1024)+dw;
        }
        else if(i>1024){//KB
            dw="KB";
            dw=getdoble00(i/1024)+dw;
        }
        else if (i<1024){//B
            dw="B";
            dw=(int)i+dw;
